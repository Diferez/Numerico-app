...
Es = {'title':"Análisis numérico",'correr':'Correr', 'biseccion':"Bisección", 'busquedas':"Búsquedas Incrementales", 'raicesI':'raices','gaussSimple':'Gaussiana Simple','solucion':'Solucion', 'graficadora':'Graficadora',
          ...
          'dFgausto' : '- Utiliza la eliminación gaussiana para encontrar el valor de sus incógnitas a través de la sustitución regresiva, pero tiene una diferencia en el procedimiento utilizado en el intercambio de filas y columnas, de modo que el elemento pivote es el valor máximo de cada submatriz obtenido en las operaciones de cada escenario.',
...
En = {'title':"Numerical analysis",'correr':'Run', 'biseccion':"Bisection", 'busquedas':"Incremental search", 'raicesI':'roots', 'gaussSimple':'Simple Gaussian','solucion':'Solution','graficadora':'Plotter',
          ...
          'dFgausto' : 'It uses Gaussian elimination to find the value of its unknowns through regressive substitution, but it has a difference in the procedure used in the exchange of rows and columns, so that the pivot element is the maximum value of each submatrix obtained in the operations of each stage.',
